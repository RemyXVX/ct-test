const main = () => {
  ...
  tab1.className = 'cursor-pointer p-2 text-slate-100 hover:text-slate-500 hover:bg-slate-200';
  ...
  tab2.className = 'cursor-pointer p-2 text-slate-100 hover:text-slate-500 hover:bg-slate-200';
